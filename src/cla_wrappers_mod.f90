...
logical :: main_code
    ...
    call cla_register('-castep', 'Parse wavefunctions generated by CASTEP.', cla_flag, 'F')
    ...
    call cla_register('-seed', 'CASTEP seed. Used to determine the appropriate ".orbitals file."', cla_char, '')
