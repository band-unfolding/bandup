...
integer :: spin_channel
    ...
    call cla_register('-outdir', "Quantum Espresso's outdir", cla_char, '.')
    call cla_register('-prefix', "Quantum Espresso's prefix", cla_char, 'pwscf')
